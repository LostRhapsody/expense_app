   ...
   >
      ...
      >
         <template #name-data="row">
            <span v-if="row.row.quantity > 0" :class="{linethrough: row.row.selected}"> {{ row.row.quantity }}x </span>
            <span v-else>&nbsp;&nbsp;</span>
            <span class="text-white" :class="{linethrough: row.row.selected}">{{ row.row.name }}</span>
         </template>
         <template #price-data="row"> <span :class="{linethrough: row.row.selected}" >${{ row.row.price }}</span> </template>
